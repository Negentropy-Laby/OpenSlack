...
const SERVICE_DOC_SECTIONS = Object.freeze([
  ...
  {
    heading: '## Imported Standalone History',
    targets: [
      `${SERVICE_ROOT}/docs/development-plan.md`,
      `${SERVICE_ROOT}/docs/ai-usage.md`,
      `${SERVICE_ROOT}/design/cdd/module-index.md`,
      `${SERVICE_ROOT}/memory_bank/t0_core/active_context.md`,
      `${SERVICE_ROOT}/memory_bank/t0_core/current_state.md`,
      ...
      `${SERVICE_ROOT}/memory_bank/t3_archive/reviews/implementation-review-archive.md`,
      `${SERVICE_ROOT}/memory_bank/t3_archive/reviews/review-index.md`,
      `${SERVICE_ROOT}/memory_bank/t3_archive/gate-archive.md`,
    ],
  },
] as const);
