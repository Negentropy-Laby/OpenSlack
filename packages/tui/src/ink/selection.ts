...
import type { Screen, StylePool, Cell } from './screen.js'
import { CellWidth, cellAt, cellAtCI, setCellStyleId } from './screen.js'
...
// `/usr/bin/bash` or `~/.aby/config.json` selects the whole thing,
