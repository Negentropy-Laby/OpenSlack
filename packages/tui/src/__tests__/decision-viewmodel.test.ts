...
describe('mapDecisionListToViewModel', () => {
  it('maps decisions with correct counts', () => {
    const decisions = [
      makeDecision(),
      makeDecision({ status: 'superseded', id: 'DEC-20260527-EFGH', supersededBy: 'DEC-20260527-IJKL' }),
    ]
...
describe('mapDecisionToViewModel', () => {
  ...
  it('maps superseded decision', () => {
    const model = mapDecisionToViewModel(makeDecision({
      status: 'superseded',
  ...
  it('handles empty alternatives and consequences', () => {
    const model = mapDecisionToViewModel(makeDecision({ alternatives: undefined, consequences: undefined }))
