...
`
  ...
  it('handles empty new section', () => {
    ...
    expect(result).toBe('<!-- openslack:latest-insights:start -->\n\n<!-- openslack:latest-insights:end -->')
  })
})
...
describe('validatePost', () => {
  ...
  it('rejects summary over 240 chars', () => {
    ...
    expect(result.valid).toBe(false)
    expect(result.errors.some((e) => e.field === 'summary' && e.message.includes('240'))).toBe(true)
  })
...
describe('sortPostsByDate', () => {
  it('sorts by date descending', () => {
    const posts = [
      { title: 'Old', date: '2026-01-01', tags: [], summary: '', status: 'published', slug: '', sourcePath: '' },
      { title: 'New', date: '2026-05-30', tags: [], summary: '', status: 'published', slug: '', sourcePath: '' },
      { title: 'Mid', date: '2026-03-15', tags: [], summary: '', status: 'published', slug: '', sourcePath: '' },
    ]
...
describe('renderLatestInsightsSection', () => {
  it('renders a list of posts', () => {
    ...
    expect(rendered).toContain('https://github.com/Negentropy-Laby/whitepapers/blob/main/posts/agent-contracts.md')
