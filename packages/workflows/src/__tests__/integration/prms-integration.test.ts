...
describe('PRMS integration', () => {
  ...
  it('prms.queue integrates with listOpenPRs', async () => {
    const api = createOpenSlackAPI({
      _listOpenPRs: async () => [
        { number: 10, title: 'Fix login', status: 'open', author: 'dev', draft: false, updatedAt: '2026-05-28T00:00:00Z', url: 'https://github.com/test/pull/10' },
        { number: 11, title: 'Add docs', status: 'open', author: 'dev', draft: false, updatedAt: '2026-05-28T00:00:00Z', url: 'https://github.com/test/pull/11' },
        { number: 12, title: 'Refactor core', status: 'open', author: 'dev', draft: false, updatedAt: '2026-05-28T00:00:00Z', url: 'https://github.com/test/pull/12' },
      ],
    })
