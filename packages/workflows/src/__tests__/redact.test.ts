...
describe('redactFailedSchemaOutput', () => {
  it('replaces output with redacted summary when validation error provided', () => {
    ...
    const result = redactFailedSchemaOutput(output, 'Missing required field "name"') as Record<
      string,
      unknown
    >;
...
describe('redactDeep', () => {
  it('walks nested objects and redacts strings', () => {
    const input = {
      message:
        'File at /home/user/project/src/main.ts with ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghij',
      nested: {
        text: '```python\nprint("hello")\n```',
      },
    };
      ...
      logEntries: [
        {
          ...
          phase: 'scan',
          message: 'Scanning with ghp_ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghij',
        },
      ],
