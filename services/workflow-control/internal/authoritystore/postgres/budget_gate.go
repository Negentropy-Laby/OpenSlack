...
func (repository *Repository) hasOpenBudgetDatabaseReconciliation(ctx context.Context, tx pgx.Tx, workspaceID, runID string) (bool, error) {
	if !repository.budgetGateEnabled {
		return false, nil
	}
	var open bool
