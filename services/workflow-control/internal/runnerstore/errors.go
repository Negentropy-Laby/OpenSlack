...
const (
	...
	ErrorUnsupportedProtocol  ErrorCode = "WORKFLOW_RUNNER_PROTOCOL_UNSUPPORTED"
	ErrorCapabilityMismatch   ErrorCode = "WORKFLOW_RUNNER_CAPABILITY_MISMATCH"
	ErrorAuthorityBinding     ErrorCode = "WORKFLOW_RUNNER_AUTHORITY_BINDING_MISMATCH"
	ErrorAuthorityUnavailable ErrorCode = "WORKFLOW_RUNNER_AUTHORITY_UNAVAILABLE"
)
