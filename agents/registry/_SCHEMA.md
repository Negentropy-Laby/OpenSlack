...
**Principle:** The registry tells the company *who* the agent is and *what* it can do. The local identity tells the agent *how* to authenticate and *where* to work locally. Only the registry is shared.
