...
[`notification-delivery-integration.md`](../notification-delivery-integration.md), and service
...
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Route configuration, final bytes, Blob, queue     | [`packages/github`](../../../packages/github/src)                                                                | [Cross-process contract](../notification-delivery-integration.md)                                 |
...
| Cross-process authority transfer                  | [`notification-delivery-integration.md`](../notification-delivery-integration.md)                                | [Repository boundaries](repository-boundaries.md)                                                 |
| Gate status                                       | Governed receipt, beginning with [`ib6-history-import.json`](../../../integration/gates/ib6-history-import.json) | [Evidence map](../../testing/notification-delivery-evidence.md)                                   |
| Product, operator, or security navigation         | Root `docs/**` entrypoints                                                                                       | [Product page](../../product/notification-delivery.md)                                            |
...
The [integration contract](../notification-delivery-integration.md) uniquely owns the semantics
...
- [Operations guide](../../guides/notification-delivery-operations.md)
