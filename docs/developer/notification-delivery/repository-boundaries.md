...
[cross-process integration contract](../notification-delivery-integration.md).
...
See the [evidence map](../../testing/notification-delivery-evidence.md) for the current distinction
