...
| Service documentation          | `services/notification-delivery/README.md`, `docs/**`, `design/**`                                                | Keep governance in the root Memory Bank and OpenSlack lifecycle claims in root docs | Update affected workspace-manifest entries; `sha256sum --check docs/testing/workspace-manifest.sha256`; `go test ./tests/contracts` | Yellow                                       |
