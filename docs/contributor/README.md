...
Linux and macOS use native Bash. Missing tools fail with an actionable diagnostic;
...
budgets. This accommodates real ACL checks, durable writes, and lock operations;
