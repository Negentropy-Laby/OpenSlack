...
| Inspect the governed IB6 import result and pending PX2 boundary                                         | `integration/notification-delivery-ib6-order-supersession.md`, `../integration/gates/ib6-history-import.json`                                                          |
...
| Review Notification Delivery Service IB6 result, PX2 boundary, and deferred release governance | `integration/notification-delivery-ib6-order-supersession.md`, `../integration/gates/ib6-history-import.json`                                                          |
