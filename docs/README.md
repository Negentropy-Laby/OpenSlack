...
| Understand the Notification Delivery Service repository and authority boundary                          | `../services/notification-delivery/README.md`, `developer/notification-delivery-integration.md`                                                                        |
| Inspect the governed IB6 import result and pending PX2 boundary                                         | `../integration/gates/ib6-history-import.json`, `integration/notification-delivery-ib6-order-supersession.md`                                                          |
...
| Inspect Notification Delivery Service repository source and integration contract               | `../services/notification-delivery/README.md`, `developer/notification-delivery-integration.md`                                                                        |
| Review Notification Delivery Service IB6 result, PX2 boundary, and deferred release governance | `../integration/gates/ib6-history-import.json`, `integration/notification-delivery-ib6-order-supersession.md`                                                          |
