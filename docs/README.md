...
| Review the notification-service contract, repository order, and 0.3.0 governance  | `developer/notification-delivery-integration.md`, `integration/notification-delivery-ib6-order-supersession.md`                                                        |
