...
id: operations-github-watch-daemon
status: In Review
authority: canonical
audience:
  - operators
...
[`notification-delivery-integration.md`](../architecture/integrations/notification-delivery.md). New notification-service admission
