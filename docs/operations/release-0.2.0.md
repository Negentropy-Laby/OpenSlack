...
- [Live capstone harness](../evidence/live-capstone.md)
- [Public npm publishing](npm-publishing.md)
- [npm rollback and recovery](npm-rollback.md)
- [Install from a release archive](../user/guides/install-openslack.md)
- [Manual upgrade and rollback](../user/guides/manual-upgrade-rollback.md)
- [Module maturity and evidence](../reference/module-maturity.md)
