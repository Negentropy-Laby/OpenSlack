...
id: archive-beta-productization-plan
status: Archived
authority: archive
audience:
  - contributors
...
`docs/user/cli-reference.md` (between Collaboration Layer and Workflow Engine sections).
Add "Maintain organization profile" row to README quick-start table and Profile Sync
bullet to Module 05 description.

**Files:**

- `docs/user/cli-reference.md` — insert "Profile Sync Robot" section with command table:
...
- `docs/contributor/tui-style-guide.md` — add sections
...
- Update docs.
  - `docs/user/cli-reference.md`: document `--dry-run`, `--repo`, `--auth`, and the
    `AUTH_REQUIRED` failure.
  - `docs/operations/github-automation.md`: clarify that direct
