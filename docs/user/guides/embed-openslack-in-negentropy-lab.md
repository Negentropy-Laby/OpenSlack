...
id: user-guide-negentropy-embedding
status: In Review
authority: canonical
audience:
  - users
...
- [`../product/negentropy-lab-integration.md`](../../../design/cdd/workstreams/negentropy-integration/README.md)
- [`../developer/negentropy-slot-adapter.md`](../../architecture/integrations/negentropy-slot-adapter.md)
