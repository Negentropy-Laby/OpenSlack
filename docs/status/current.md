...
3371 passing Vitest tests across 249 passing files. No failures recorded.

Module-attributed coverage: 3605 tests across 351 module test files (packages shared across modules are counted per module).
