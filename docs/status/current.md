...
3682 passing Vitest tests across 289 passing files. No failures recorded.

Module-attributed coverage: 3925 tests across 388 module test files (packages shared across modules are counted per module).
