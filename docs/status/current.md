...
3506 passing Vitest tests across 264 passing files. No failures recorded.

Module-attributed coverage: 3705 tests across 364 module test files (packages shared across modules are counted per module).
