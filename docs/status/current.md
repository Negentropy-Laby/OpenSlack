...
3329 passing Vitest tests across 246 passing files. No failures recorded.

Module-attributed coverage: 3550 tests across 346 module test files (packages shared across modules are counted per module).
