...
3187 Vitest tests across 230 files. All passing.

Module-attributed coverage: 3409 tests across 328 module test files (packages shared across modules are counted per module).
