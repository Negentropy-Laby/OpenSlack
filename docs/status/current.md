...
3653 passing Vitest tests across 286 passing files. No failures recorded.

Module-attributed coverage: 3858 tests across 383 module test files (packages shared across modules are counted per module).
