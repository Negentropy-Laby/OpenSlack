...
3558 passing Vitest tests across 277 passing files. No failures recorded.

Module-attributed coverage: 3766 tests across 378 module test files (packages shared across modules are counted per module).
