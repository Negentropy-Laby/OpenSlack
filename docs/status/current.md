...
4220 passing Vitest tests across 330 passing files. No failures recorded.

Module-attributed coverage: 4750 tests across 447 module test files (packages shared across modules are counted per module).
