...
3174 Vitest tests across 225 files. All passing.

Module-attributed coverage: 3395 tests across 323 module test files (packages shared across modules are counted per module).
