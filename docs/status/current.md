...
3344 passing Vitest tests across 248 passing files. No failures recorded.

Module-attributed coverage: 3576 tests across 350 module test files (packages shared across modules are counted per module).
