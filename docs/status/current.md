...
4168 passing Vitest tests across 325 passing files. No failures recorded.

Module-attributed coverage: 4669 tests across 439 module test files (packages shared across modules are counted per module).
