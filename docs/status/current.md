...
3698 passing Vitest tests across 290 passing files. No failures recorded.

Module-attributed coverage: 3935 tests across 388 module test files (packages shared across modules are counted per module).
