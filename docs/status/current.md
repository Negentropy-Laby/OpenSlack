...
4084 passing Vitest tests across 316 passing files. No failures recorded.

Module-attributed coverage: 4495 tests across 422 module test files (packages shared across modules are counted per module).
