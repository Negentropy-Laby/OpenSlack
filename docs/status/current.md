...
3305 passing Vitest tests across 245 passing files. No failures recorded.

Module-attributed coverage: 3525 tests across 345 module test files (packages shared across modules are counted per module).
