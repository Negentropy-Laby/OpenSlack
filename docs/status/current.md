...
3185 Vitest tests across 230 files. All passing.

Module-attributed coverage: 3406 tests across 328 module test files (packages shared across modules are counted per module).
