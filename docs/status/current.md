...
2996 Vitest tests across 216 files. All passing.

Module-attributed coverage: 3380 tests across 321 module test files (packages shared across modules are counted per module).
