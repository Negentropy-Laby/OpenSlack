...
3777 passing Vitest tests across 294 passing files. No failures recorded.

Module-attributed coverage: 4188 tests across 400 module test files (packages shared across modules are counted per module).
