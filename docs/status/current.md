...
4268 passing Vitest tests across 338 passing files. No failures recorded.

Module-attributed coverage: 4797 tests across 455 module test files (packages shared across modules are counted per module).
