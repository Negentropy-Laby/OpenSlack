...
2989 Vitest tests across 215 files. All passing.

Module-attributed coverage: 3373 tests across 320 module test files (packages shared across modules are counted per module).
