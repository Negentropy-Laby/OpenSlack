...
4140 passing Vitest tests across 322 passing files. No failures recorded.

Module-attributed coverage: 4641 tests across 436 module test files (packages shared across modules are counted per module).
