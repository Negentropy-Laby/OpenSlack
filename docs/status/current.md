...
3828 passing Vitest tests across 297 passing files. No failures recorded.

Module-attributed coverage: 4239 tests across 403 module test files (packages shared across modules are counted per module).
