...
3776 passing Vitest tests across 294 passing files. No failures recorded.

Module-attributed coverage: 4185 tests across 400 module test files (packages shared across modules are counted per module).
