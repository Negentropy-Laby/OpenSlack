...
3600 passing Vitest tests across 282 passing files. No failures recorded.

Module-attributed coverage: 3789 tests across 378 module test files (packages shared across modules are counted per module).
