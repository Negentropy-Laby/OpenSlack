...
3208 Vitest tests across 236 files. All passing.

Module-attributed coverage: 3434 tests across 336 module test files (packages shared across modules are counted per module).
