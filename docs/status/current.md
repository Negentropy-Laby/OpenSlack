...
4095 passing Vitest tests across 318 passing files. No failures recorded.

Module-attributed coverage: 4506 tests across 424 module test files (packages shared across modules are counted per module).
