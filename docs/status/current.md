...
4048 passing Vitest tests across 312 passing files. No failures recorded.

Module-attributed coverage: 4459 tests across 418 module test files (packages shared across modules are counted per module).
