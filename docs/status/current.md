...
3273 passing Vitest tests across 239 passing files. No failures recorded.

Module-attributed coverage: 3493 tests across 339 module test files (packages shared across modules are counted per module).
