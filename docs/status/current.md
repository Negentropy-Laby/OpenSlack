...
3618 passing Vitest tests across 283 passing files. No failures recorded.

Module-attributed coverage: 3808 tests across 379 module test files (packages shared across modules are counted per module).
