...
4184 passing Vitest tests across 325 passing files. No failures recorded.

Module-attributed coverage: 4685 tests across 439 module test files (packages shared across modules are counted per module).
