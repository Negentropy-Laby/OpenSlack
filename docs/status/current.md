...
4155 passing Vitest tests across 324 passing files. No failures recorded.

Module-attributed coverage: 4659 tests across 438 module test files (packages shared across modules are counted per module).
