...
3281 passing Vitest tests across 240 passing files. No failures recorded.

Module-attributed coverage: 3501 tests across 340 module test files (packages shared across modules are counted per module).
