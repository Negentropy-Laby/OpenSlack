...
3254 passing Vitest tests across 238 passing files. No failures recorded.

Module-attributed coverage: 3468 tests across 338 module test files (packages shared across modules are counted per module).
