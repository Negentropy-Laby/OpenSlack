...
3276 passing Vitest tests across 239 passing files. No failures recorded.

Module-attributed coverage: 3496 tests across 339 module test files (packages shared across modules are counted per module).
