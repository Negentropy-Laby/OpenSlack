...
2981 Vitest tests across 214 files. All passing.

Module-attributed coverage: 3365 tests across 319 module test files (packages shared across modules are counted per module).
