...
3637 passing Vitest tests across 285 passing files. No failures recorded.

Module-attributed coverage: 3842 tests across 382 module test files (packages shared across modules are counted per module).
