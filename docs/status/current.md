...
2910 Vitest tests across 207 files. All passing.

Module-attributed coverage: 3299 tests across 312 module test files (packages shared across modules are counted per module).
