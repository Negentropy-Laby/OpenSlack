...
This document defines the Collaboration Layer: the set of views and projections that make human-agent collaboration observable, traceable, and actionable. For the planned Negentropy-Lab integration boundary, see [docs/product/negentropy-lab-integration.md](docs/product/negentropy-lab-integration.md); the Collaboration Layer stays projection-only and does not own any authority state.
