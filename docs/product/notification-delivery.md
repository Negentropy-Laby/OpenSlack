...
Use [metadata-only reconciliation](../guides/notification-delivery-operations.md#reconcile-one-route)
...
| Goal                                  | Read                                                                                    |
| ------------------------------------- | --------------------------------------------------------------------------------------- |
| Check readiness and operate the queue | [Operations guide](../guides/notification-delivery-operations.md)                       |
| Find the exact CLI flags              | [CLI reference](../user-guide.md)                                                       |
| Decide where to change code           | [Developer entrypoint](../developer/notification-delivery/README.md)                    |
| Understand authority transfer         | [Cross-process integration contract](../developer/notification-delivery-integration.md) |
| Review the security boundary          | [Security boundary](../security/notification-delivery-boundary.md)                      |
| Inspect gate and test evidence        | [Evidence map](../testing/notification-delivery-evidence.md)                            |
