...
| Develop the Notification Delivery Service      | `services/notification-delivery/README.md`, `docs/developer/notification-delivery-integration.md`                                             | `go build ./...`, `go vet ./...`, `go test -race ./...`                                                                       |
...
| Inspect IB6 and PX2 evidence                   | `integration/gates/ib6-history-import.json`, `docs/integration/notification-delivery-ib6-order-supersession.md`                               | Read the receipt; do not infer PX2, IB7, release, or live delivery                                                            |
