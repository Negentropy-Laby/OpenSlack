...
| Operate durable notifications                  | `docs/product/notification-delivery.md`, `docs/guides/notification-delivery-operations.md`                                                    | `openslack github notifications doctor`, `status`, `queue`, `reconcile`                                                       |
| Understand notification authority transfer     | `docs/product/notification-delivery.md`, `docs/developer/notification-delivery-integration.md`                                                | `openslack github notifications reconcile <route-record-id>`                                                                  |
| Develop the Notification Delivery Service      | `docs/developer/notification-delivery/README.md`, `services/notification-delivery/README.md`                                                  | Use the change-and-test guide to select the owning boundary and gates                                                         |
| Review the delivery security boundary          | `docs/security/notification-delivery-boundary.md`, `services/notification-delivery/docs/security/threat-model.md`                             | Read-only documentation and governed review                                                                                   |
| Inspect IB6 and PX2 evidence                   | `docs/testing/notification-delivery-evidence.md`, `docs/integration/notification-delivery-ib6-order-supersession.md`                          | Read the evidence map and receipt; do not infer PX2, IB7, release, or live delivery                                           |
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Notification Delivery Service | Repository import is complete; PX2 is pending, runtime admission remains gated, and no release or live claim is made | `docs/product/notification-delivery.md`, `docs/developer/notification-delivery/README.md`, `services/notification-delivery/README.md` |
