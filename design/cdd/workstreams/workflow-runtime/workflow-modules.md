...
- Update `docs/status/current.md` and `docs/user/cli-reference.md`
...
| [user-experience-roadmap.md](../../../ux/product-roadmap.md)             | UX roadmap including workflow TUI integration                           |
| [module-04-pr-review-merge-steward.md](../../modules/pr-review-merge.md) | PRMS gates that workflows must pass through                             |
| [collaboration-layer.md](../../modules/collaboration.md)                 | Collaboration events and handoff integration                            |
| `docs/architecture/components/workflow-runtime.md`                       | Technical runtime design (separate document)                            |
