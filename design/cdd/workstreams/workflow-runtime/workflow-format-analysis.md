...
id: cdd-workflow-format-analysis
status: In Review
authority: canonical
audience:
  - contributors
...
| --- | ------------------------------- | ----------------------------------------------------------------------------------------------------- |
| 1   | Format analysis docs            | `design/cdd/workstreams/workflow-runtime/workflow-format-analysis.md`, runtime design, security model |
...
- `docs/architecture/components/workflow-runtime.md` — Technical runtime design for `@openslack/workflows`
